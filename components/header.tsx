...
export function Header() {
  ...
  const { open: openPhotoUpload } = usePhotoUploadModal()
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between lg:h-18">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <Button size="sm" className="gap-2 bg-primary hover:bg-primary/90" onClick={openPhotoUpload}>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              <nav className="flex flex-col gap-4 pt-8">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  ...
                  <Button variant="outline" className="w-full gap-2" onClick={() => { setIsOpen(false); openPhotoUpload(); }}>
                    <Camera className="size-4" />
                    Fotoğraf Gönder
                  </Button>
                </div>
